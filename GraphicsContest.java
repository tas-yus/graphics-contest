...
public class GraphicsContest extends GraphicsProgram {
	...
	private void setUpIcons() {
		...
		add(icon5);
		icon6 = new GRect (icon6.getX() + icon6.getWidth(), 0, M_ICON_WIDTH, ICON_HEIGHT);
		add(icon7);
		icon7 = new GRect (icon5.getX() + icon5.getWidth(), 0, M_ICON_WIDTH, ICON_HEIGHT);
		add(icon6);
		icon8 = new GRect (icon6.getX() + icon6.getWidth(), 0, M_ICON_WIDTH, ICON_HEIGHT);
		add(icon7);
